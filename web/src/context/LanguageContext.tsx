...
const translations: Record<string, TranslationSet> = {
  ...
  "drawer.title": { hi: "मेरा प्रोफ़ाइल एवं सेवाएं", en: "My profile and services", mr: "माझे प्रोफाइल आणि सेवा", gu: "મારી પ્રોફાઇલ અને સેવાઓ" },
  "drawer.close": { hi: "प्रोफाइल बंद करें", en: "Close profile", mr: "प्रोफाइल बंद करा", gu: "પ્રોફાઇલ બંધ કરો" },
  "drawer.user": { hi: "किसान साथी", en: "Farmer companion", mr: "शेतकरी साथी", gu: "ખેડૂત સાથી" },
  "drawer.userSubtitle": { hi: "अपना खाता बनाएं / विवरण देखें", en: "Create an account / view details", mr: "खाते तयार करा / तपशील पहा", gu: "ખાતું બનાવો / વિગતો જુઓ" },
  "drawer.sampleProfile": { hi: "नमूना प्रोफाइल", en: "Sample profile", mr: "नमुना प्रोफाइल", gu: "નમૂના પ્રોફાઇલ" },
  "drawer.allServices": { hi: "सभी 12 सेवाएं", en: "All 12 services", mr: "सर्व 12 सेवा", gu: "બધી 12 સેવાઓ" },
  "drawer.sampleServices": { hi: "नमूना सेवाएं", en: "Sample services", mr: "नमुना सेवा", gu: "નમૂના સેવાઓ" },
  "drawer.sampleLogin": { hi: "नमूना लॉगिन", en: "Sample login", mr: "नमुना लॉगिन", gu: "નમૂના લૉગિન" },
  "drawer.login": { hi: "लॉग इन / साइन अप", en: "Log in / Sign up", mr: "लॉग इन / साइन अप", gu: "લૉગ ઇન / સાઇન અપ" },
  ...
  "footer.research": { hi: "शोध एवं सलाह", en: "Research and guidance", mr: "संशोधन आणि मार्गदर्शन", gu: "સંશોધન અને માર્ગદર્શન" },
  ...
  "service.crops.title": { hi: "फसल", en: "Crops", mr: "पिके", gu: "પાક" },
  "service.fertilizer.title": { hi: "उर्वरक", en: "Fertiliser", mr: "खते", gu: "ખાતર" },
  "service.calculator.title": { hi: "कैलकुलेटर", en: "Calculator", mr: "कॅल्क्युलेटर", gu: "કેલ્ક્યુલેટર" },
  "service.notifications.title": { hi: "सूचनाएं", en: "Updates", mr: "सूचना", gu: "સૂચનાઓ" },
  "service.video.title": { hi: "वीडियो", en: "Videos", mr: "व्हिडिओ", gu: "વિડિયો" },
  "service.profile.title": { hi: "प्रोफाइल", en: "Profile", mr: "प्रोफाइल", gu: "પ્રોફાઇલ" },
  "home.schemes.title": { hi: "प्रमुख योजनाएं", en: "Key schemes", mr: "प्रमुख योजना", gu: "મુખ્ય યોજનાઓ" },
  "home.schemes.cta": { hi: "सभी योजनाएं देखें", en: "View all schemes", mr: "सर्व योजना पहा", gu: "બધી યોજનાઓ જુઓ" },
  ...
  "home.result.cta": { hi: "पात्रता जाँचें", en: "Check eligibility", mr: "पात्रता तपासा", gu: "પાત્રતા તપાસો" },
