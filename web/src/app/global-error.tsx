...
export default function GlobalError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <html lang="hi">
      <body style={{ margin: 0, background: "#faf8f5", color: "#1a1a1a", font: "19px/1.6 sans-serif" }}>
        <header style={{ borderBottom: "1px solid #d6d1c9", background: "#fff" }}>
        ...
        <main style={{ maxWidth: 560, minHeight: "60vh", margin: "auto", padding: "32px 20px" }}>
          <section style={{ border: "2px solid #c1272d", background: "#fff", padding: 20 }}>
            ...
            <button type="button" onClick={reset} style={{ minHeight: 56, border: 0, padding: "12px 20px", color: "#fff", background: "#1a1a1a", font: "inherit", fontWeight: 700 }}>
              पन्ना फिर खोलें
            </button>
            <p><Link href="/#demo-numbers" style={{ color: "inherit", fontWeight: 700 }}>नमूना निदान देखें</Link></p>
          </section>
        </main>
        <footer style={{ borderTop: "1px solid #d6d1c9" }}>
